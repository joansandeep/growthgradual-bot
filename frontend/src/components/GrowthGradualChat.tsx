    ...
    <>
      <style>{`
        ...
        .sidebar-hdr {
          ...
          flex-shrink: 0;
          background: linear-gradient(180deg,#f8f9fd 0%,#f4f5fa 100%);
        }
        .sidebar-logo {
        ...
        .new-chat-btn {
          ...
          padding: 9px 13px;
          border-radius: 9px;
          border: 1.5px solid #1a1f4e;
          background: linear-gradient(135deg,#0d4f3c,#1a1f4e);
          color: #fff;
          ...
          flex-shrink: 0;
          white-space: nowrap;
          box-shadow: 0 2px 10px rgba(13,79,60,.28);
          font-weight: 600;
        }
        .new-chat-btn:hover { background: linear-gradient(135deg,#0f5c47,#252b68); box-shadow: 0 4px 16px rgba(13,79,60,.35); transform:translateY(-1px); }
        ...
        .sidebar-footer {
          ...
          border-top: 1px solid rgba(26,31,78,.1);
          font-size: 10px; color: #8b93b5;
          font-family: 'DM Sans',sans-serif;
          flex-shrink: 0;
          white-space: nowrap;
        ...
        .chat-topbar {
          ...
          background: #ffffff;
          border-bottom: 1px solid rgba(26,31,78,.09);
          flex-shrink: 0;
          box-shadow: 0 1px 6px rgba(26,31,78,.05);
        }
        .topbar-toggle {
        ...
        .topbar-logo {
          ...
          background: linear-gradient(135deg,#0d4f3c,#1a1f4e); overflow:hidden;
          display:flex; align-items:center; justify-content:center;
          flex-shrink:0;
          border: 1px solid rgba(13,79,60,.2);
          box-shadow: 0 2px 8px rgba(13,79,60,.2);
        }
        ...
        .topbar-web-badge { margin-left:auto; display:flex;align-items:center;gap:5px; padding:5px 12px; background:linear-gradient(135deg,rgba(13,79,60,.08),rgba(13,79,60,.04)); border:1px solid rgba(13,79,60,.22); border-radius:20px; font-size:11px; color:#0d4f3c; font-family:'DM Sans',sans-serif; font-weight:600; white-space:nowrap; box-shadow:0 1px 4px rgba(13,79,60,.08); }
        ...
        .msg-row--user .msg-text {
          ...
          box-shadow:0 2px 10px rgba(26,31,78,.2);
        }
        .msg-row--bot .msg-text {
          background:#ffffff; color:#1a1f4e;
          border:1px solid #e2e6f0;
          border-bottom-left-radius:5px;
          border-left:3px solid rgba(13,79,60,.18);
          box-shadow:0 1px 6px rgba(26,31,78,.06);
        }
        ...
        .msg-text .md-table th { background:linear-gradient(90deg,#0d4f3c,#1a1f4e); color:#fff; font-weight:600; font-size:11px; text-transform:uppercase; letter-spacing:.04em; border:1px solid #1a3a30; padding:6px 9px; text-align:left; }
        .msg-text .md-th { background:linear-gradient(90deg,#0d4f3c,#1a1f4e); color:#fff; font-weight:600; font-size:11px; text-transform:uppercase; letter-spacing:.04em; border:1px solid #1a3a30; padding:6px 9px; text-align:left; }
        ...
        .searching {
          ...
          padding:10px 14px; background:rgba(13,79,60,.07); border:1px solid rgba(13,79,60,.18);
          border-radius:12px; font-size:12px; color:#0d4f3c; border-bottom-left-radius:4px;
        }
        ...
        .report-btn { display:flex;align-items:center;gap:5px;background:linear-gradient(135deg,#0d4f3c,#1a1f4e);border:none;border-radius:7px;padding:6px 12px;font-size:11px;color:#fff;cursor:pointer;font-family:'DM Sans',sans-serif;transition:opacity .15s,box-shadow .15s;box-shadow:0 2px 8px rgba(13,79,60,.25); }
        ...
        .report-content .md-table th{background:linear-gradient(90deg,#0d4f3c,#1a1f4e);color:#fff;font-weight:600;font-size:11px;text-transform:uppercase;letter-spacing:.04em;border:1px solid #1a3a30;padding:7px 10px;text-align:left;}
        .report-content .md-th{background:linear-gradient(90deg,#0d4f3c,#1a1f4e);color:#fff;font-weight:600;font-size:11px;text-transform:uppercase;letter-spacing:.04em;border:1px solid #1a3a30;padding:7px 10px;text-align:left;}
        ...
        @keyframes logoGlow {
          0%,100% { box-shadow:0 0 0 8px rgba(13,79,60,.08), 0 12px 36px rgba(13,79,60,.28); }
          50%      { box-shadow:0 0 0 14px rgba(13,79,60,.12), 0 16px 44px rgba(13,79,60,.36); }
        }
        .welcome-glow::before {
        ...
        .waction:hover .waction-icon { transform:scale(1.1); }
        .waction-icon { transition:transform .18s; }
        .waction--chat {
          background:#fff;
          border-color:#d4e4dd;
        ...
        .chat-input-area {
          ...
          background: #ffffff;
          border-top: 1px solid rgba(26,31,78,.09);
          flex-shrink: 0;
        ...
        /* ── Attach button ───────────────────────────────────────────────── */
        .attach-btn {
          width:32px;height:32px;border-radius:9px;border:1.5px solid #ccddd6;
          background:#f0f8f4;color:#0d4f3c;cursor:pointer;flex-shrink:0;
          display:flex;align-items:center;justify-content:center;
        ...
        /* ── News mode button in input ───────────────────────────────────── */
        .news-btn {
          height:32px;padding:0 12px;border-radius:9px;border:1.5px solid #c7ccdc;
        ...
        <aside className={`sidebar${sidebarOpen ? '' : ' sidebar--closed'}`}>
          ...
          <div className="sidebar-hdr">
            <div className="sidebar-logo">
              <Image src="/growth-gradual-icon-transparent.png" alt="Growth Gradual" width={32} height={32} style={{ objectFit:'contain' }}/>
            </div>
        ...
        <div className="chat-main">
          ...
          <div className="chat-topbar">
            ...
            <div className="topbar-logo">
              <Image src="/growth-gradual-icon-transparent.png" alt="Growth Gradual" width={30} height={30} style={{ objectFit:'contain' }}/>
            </div>
            ...
            {isEmpty ? (
              <div className="chat-welcome">
                ...
                <div className="welcome-glow">
                  <Image src="/growth-gradual-icon-transparent.png" alt="Growth Gradual" width={72} height={72} style={{ objectFit:'contain' }}/>
                </div>
                ...
                <div className="welcome-actions">
                  ...
                  {/* Attach & Ask */}
                  <button className="waction waction--attach" onClick={() => fileInputRef.current?.click()}>
                    <div className="waction-icon">📎</div>
                  ...
                  {/* Market News */}
                  <button className="waction waction--news" onClick={() => send('What are the top Indian market news and market-moving events today?')}>
                    <div className="waction-icon">📰</div>
          ...
          <div className="chat-input-area">
            ...
            <div className="input-row">
              ...
              {!input.trim() && (
                <button
                  className="news-btn"
                  onClick={() => send('What are the top Indian market news and market-moving events today?')}
                  disabled={streaming}
                  title="Get today's market news"
                >
                  <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><path d="M4 22h16a2 2 0 002-2V4a2 2 0 00-2-2H8a2 2 0 00-2 2v2"/><path d="M2 12h6m-6 4h6M2 8h6"/></svg>
                  News
                </button>
              )}
