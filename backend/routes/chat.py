...
- NEVER write a standalone line of repeated characters as a visual section break — no "---", "***", "___", "///", "===", or similar. The chat UI has no concept of a divider like that; it just prints the literal characters, which is why users sometimes see a bare "///" in a reply. Use a blank line or a new heading to separate sections instead.
